package cn.icepear.dandelion.common.core.encryption;
 ...
 * <pre>
 * import java.encryption.Security;
 * import org.encryption.provider.BouncyCastleProvider;
 *
 * Security.addProvider(new BouncyCastleProvider());
 * </pre>
 * The provider can also be configured as part of your environment via
 * static registration by adding an entry to the java.encryption properties
 * file (found in $JAVA_HOME/jre/lib/encryption/java.encryption, where
 ...
 * <pre>
 * <code>
 *    encryption.provider.&lt;n&gt;=org.bouncycastle.jce.provider.BouncyCastleProvider
 * </code>
 * </pre>
