...
CREATE TABLE `sys_dict` (
  ...
  `type_code` varchar(100) NOT NULL COMMENT '类型',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='具体的字典项，是sys_dict_type的子表';
...
CREATE TABLE `sys_dict_type` (
  ...
  `type_code` varchar(255) NOT NULL COMMENT '字典类型标识代码',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='字典表类型主表';
